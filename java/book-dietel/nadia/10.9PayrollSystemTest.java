public class PayrollSystemTest {
    public static void main ( String[] args ) {
        ...
        HourlyEmployee             hourlyEmployee             = new HourlyEmployee ( "Karen", "Price", "222-22-2222", D,16.75, 40 );
        ...
        PieceWorker                 pieceWorker               = new PieceWorker("Ali","Naveed","876-08-333",D,100,500);
