...
CREATE TABLE `basepluscommissionemployees` (
  ...
  KEY `basePluscommissionEmployees_employees_SocialSecurityNumber_fk` (`SocialSecurityNumber`),
  CONSTRAINT `basePluscommissionEmployees_employees_SocialSecurityNumber_fk` FOREIGN KEY (`SocialSecurityNumber`) REFERENCES `employees` (`SocialSecurityNumber`)
...
INSERT INTO `basepluscommissionemployees` VALUES (4,4000,0.5,390,0.3),(7,2000,0.2,500,0.1);
