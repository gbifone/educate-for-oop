...
CREATE TABLE `salariedemployees` (
  ...
  KEY `salariedEmployees_employee_SocialSecurityNumber_fk` (`SocialSecurityNumber`),
  CONSTRAINT `salariedEmployees_employee_SocialSecurityNumber_fk` FOREIGN KEY (`SocialSecurityNumber`) REFERENCES `employee` (`SocialSecurityNumber`)
...
INSERT INTO `salariedemployees` VALUES ('rk001',3000,0.5),('rk004',2000,0.3),('rk005',4000,0.5);
...
-- Dump completed on 2017-08-01 19:22:22
